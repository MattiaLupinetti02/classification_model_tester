...
import pandas as pd
import numpy as np
from sklearn.experimental import enable_halving_search_cv  # 👈 deve venire PRIMA
from sklearn.model_selection import train_test_split, learning_curve, validation_curve, GridSearchCV,RandomizedSearchCV, cross_val_score,HalvingGridSearchCV
...
tester.best_param_calculator_ensamble_from_augmented_data_by_label(cv=2,searcher_class=RandomizedSearchCV)
#tester.make_dataframe_performances(tester.performances).to_csv("performances_ensamble_dt1.csv",index=False)